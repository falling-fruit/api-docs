...
6. If you did everything correct, https://falling-fruit.github.io/api-docs/ will lead to your new docs
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://falling-fruit.github.io/api-docs/ with url from the message: `Server started <url>`
